...
// user is asked for initial input, please select password length.
        var generatePassword = function(){
            ...
            if (password <= ) {
                window.prompt('Your password must be 8 or more characters.');
...
var selectType = function() {
    window.prompt('You must select at least one type of character for your password to generate. Please choose from: uppercase, lowercase, special, numeric, or all');
    if (upperChar) {
